...
// TIDAK ADA IMPORT SLIDESHOW DI SINI

export default function VisiMisi() {
  return (
    <section className="w-full bg-gradient-to-b from-[#2BB673] via-[#A6E6C6] to-white py-20 text-gray-900 overflow-hidden">

      {/* HANYA KONTEN TEKS VISI MISI */}
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <motion.div
          ...
          className="shadow-lg p-16 mb-16 w-full mx-auto text-white rounded-tr-[50px] rounded-br-[50px] rounded-bl-[50px] rounded-tl-none"
          style={{
            background:
              "linear-gradient(135deg, #004D2C 65%, #118C54 85%, #1DAE63 100%)",
          }}
        >
        ...
        <motion.div
          ...
          className="relative shadow-lg p-16 w-full mx-auto text-white rounded-tl-[50px] rounded-br-[50px] rounded-bl-[50px] rounded-tr-none"
          style={{
            background:
              "linear-gradient(315deg, #004D2C 65%, #118C54 85%, #1DAE63 100%)",
          }}
        >
