...
const slides = [
  {
    src: "/images/akreditasi-yarsi.png",
    alt: "Akreditasi Unggul Universitas YARSI",
  },
  {
    src: "/images/cdc-yarsi.png",
    alt: "Career Development Center Universitas YARSI",
  },
];
...
export default function VisiMisi() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#2BB673] via-[#A6E6C6] to-white py-20 px-6 lg:px-12 text-gray-900 overflow-hidden">
      ...
      {/* SLIDESHOW */}
      <div className="relative w-[95%] mx-auto h-[650px] mb-20 rounded-3xl overflow-hidden shadow-2xl border border-white/20">
      ...
      <motion.div
        ...
        className="shadow-lg p-16 mb-16 w-[95%] mx-auto text-white 
      ...
      <motion.div
        ...
        className="relative shadow-lg p-16 w-[95%] mx-auto text-white
