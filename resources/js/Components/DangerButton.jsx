/**
 * Komponen Tombol Bahaya (Warna Merah)
 * Biasanya buat aksi yang nggak bisa balik lagi kayak 'Hapus'.
 * Otomatis nanganin style pas tombol di-disable (jadi agak transparan).
 */
