...
const DUMMY_MAGANG = [
    {
        ...
        logoUrl: "/images/IF1.jpg",
    },
    {
        id: 2,
        judul: "Peluang Magang sebagai Content Creator di Perusahaan Teknologi",
        logoUrl: "/images/IF2.jpg",
    },
    {
        id: 3,
        judul: "Accenture Collaborates with 1910 Genetics to Help Biopharma",
        logoUrl: "/images/IF3.jpg",
    },
    {
        id: 4,
        judul: "Lowongan Internship di Divisi Data Science & AI Startup",
        logoUrl: "/images/IF4.jpg",
    },
];

const InfoMagang = () => {
    const primaryGreen = 'bg-green-700';
    const brightAccent = 'bg-teal-300';
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4 md:px-8 max-w-6xl">

                <div className="flex items-center mb-10">
                    <h2 className="text-4xl md:text-5xl font-serif text-black pr-4 whitespace-nowrap">
                        INFO MAGANG
                    </h2>

                    <div className="flex-grow border-b-4 border-black h-px"></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 justify-items-center">
                    {DUMMY_MAGANG.map((magang) => (
                        ...
                        >
                            {}
                            <div className="w-full h-48 bg-[#0E072D] flex items-center justify-center p-6">
                                <img
                                    src={magang.logoUrl}
                                    alt={`Ilustrasi Magang ${magang.id}`}
                                    className="h-full w-full object-cover"
                                    onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/600x400/0E072D/FFFFFF?text=Logo+Magang" }}
                                />
                            </div>
                ...
                <div className="text-center mt-16">
                    <a
                        href="#"
                        className={`inline-block px-12 py-3 text-lg font-bold rounded-full text-green-900 shadow-xl hover:bg-teal-400 transition-all transform hover:scale-[1.05]
