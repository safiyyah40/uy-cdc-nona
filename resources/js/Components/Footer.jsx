...
// Icon Email menggunakan format SVG inline
...
// Icon Instagram menggunakan format SVG inline
...
/**
 * Komponen Footer CDC
 * Menampilkan informasi alamat kampus, kontak bidang karir, dan hak cipta.
 */
const Footer = () => {
    ...
    return (
        <footer className="bg-white font-inter">
            ...
            {/* Bagian Utama Footer: Latar belakang hijau muda (Alamat & Kontak) */}
            <div className="bg-[#E5F3E5] py-16">
                <div className="mx-auto w-full">
                    <div className="flex flex-col md:flex-row justify-between items-start w-full max-w-screen-2xl mx-auto">
                        ...
                        {/* Kiri: Logo CDC dan detail alamat Universitas */}
                        ...
                        {/* Kanan: Link kontak (Email & Media Sosial) */}
            ...
            {/* Bagian Bawah: Baris Hak Cipta dengan tahun dinamis */}
