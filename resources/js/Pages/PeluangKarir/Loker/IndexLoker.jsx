...
import {
    Calendar, MapPin, Briefcase, Search, Filter,
    Clock, ArrowRight, Building2, Wallet, TrendingUp, Award, CheckCircle, Star
} from 'lucide-react';
...
export default function IndexLoker({ auth, lokers, pagination, filters, isGuest, total, categoriesList, locationsList }) {
    ...
    // INJECT CSS ANIMATION (Untuk efek blob di background)
    useEffect(() => {
    ...
    const handlePerPageChange = (e) => {
        ...
        router.get(route('loker.index'), {
            search: searchTerm, category: selectedCategory, location: selectedLocation, per_page: e.target.value
        }, { preserveState: true, preserveScroll: true });
    };
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-gray-700 font-sans max-w-2xl mx-auto lg:mx-0 font-light mb-6 sm:mb-8">
                                Temukan berbagai peluang kerja sesuai bidang dan keahlian Anda. Halaman ini menyajikan informasi lowongan pekerjaan dari beragam sumber terpercaya untuk membantu Anda menemukan karier yang tepat dan sesuai dengan tujuan profesional Anda.
                            </p>
                            {/* Stats */}
                                    ...
                                    <div className="md:col-span-3 relative">
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="w-full pl-11 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-2xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 appearance-none cursor-pointer font-medium text-gray-700 transition-all outline-none"
                                            >
                                    ...
                                    <div className="md:col-span-3 relative">
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="w-full pl-11 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-2xl focus:border-yarsi-green focus:ring-2 focus:ring-yarsi-accent/20 appearance-none cursor-pointer font-medium text-gray-700 transition-all outline-none"
                                            >
                                ...
                                {(filters?.search || (filters?.category && filters.category !== 'all') || (filters?.location && filters.location !== 'all')) && (
                                    <div className="mt-4 flex items-center flex-wrap gap-3 pt-4 border-t border-gray-100">
                                        ...
                                        {filters?.category && filters.category !== 'all' && (
                                            <span className="px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm font-bold border border-indigo-200">
                                                {filters.category}
                                            </span>
                                        )}
