...
// Route untuk halaman Sertifikasi
Route::get('/peluang-karir/sertifikasi', function () {
    // Pastikan path ini sesuai dengan lokasi file JSX Anda
    return Inertia::render('PeluangKarir/Sertifikasi/IndexSertifikasi', [
        // data yang mungkin Anda butuhkan, contoh:
        'sertifikasies' => [], // Misalnya data sertifikasi dari database
    ]);
})->name('sertifikasi.index');

// Route BARU untuk Detail Sertifikasi
// Asumsi Anda akan membuat komponen Pages/PeluangKarir/Sertifikasi/ShowSertifikasi.jsx
