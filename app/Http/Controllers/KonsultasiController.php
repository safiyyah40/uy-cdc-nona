        ...
        $bookings = $query->orderBy('created_at', 'desc')
            ...
            ->through(function ($booking) {
                ...
                return [
                    ...
                    'schedule' => Carbon::parse($booking->scheduled_date)->locale('id')->isoFormat('dddd, D MMM YYYY').', '.$startTime.' WIB',
    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function () use ($validated, $request, $user) {
                ...
                // KUNCI SLOT (Pessimistic Locking)
                // 'lockForUpdate' mencegah user lain membaca/mengedit baris ini sampai proses ini selesai
                $slot = CounselorSlot::where('id', $validated['slot_id'])
                    ->lockForUpdate()
                    ->first();
                ...
                CounselingBooking::create([
                    ...
                    // Snapshot data mahasiswa (antisipasi jika user update profil di masa depan, data history tetap sama)
                ...
                // 4. UPDATE SLOT MENJADI UNAVAILABLE
            ...
            // JIKA GAGAL (Slot rebutan / Error lain)
